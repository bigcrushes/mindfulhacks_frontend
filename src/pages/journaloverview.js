...
function createData(date, title, summary, riskScore, id) {
  return { date, title, summary, riskScore, id };
}

const rows = [
  createData("06 May 2022",'Sample Title', 'Sample Summary', 65, "fs23423"),
  createData("31 Aug 2022",'Sample Title', 'Sample Summary', 60, "sdf6432423"),
];
